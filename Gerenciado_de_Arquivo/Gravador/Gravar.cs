...
namespace BurnMedia
{
    ...
    public partial class Gravar : Form
    {
        ...
        void addItens()
        {
            ...
            {
                var fileItem = new FileItem(line);
        ...
        private void MainForm_Load(object sender, EventArgs e)
        {
            ...
            buttonDetectMedia_Click(sender, e);
            BtnTabGravar_Click(sender, e);
        }
        ...
        private void backgroundFormatWorker_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            labelFormatStatusText.Text = (int)e.Result == 0 ?
                "Disco Formatado com Sucesso!" : "Erro ao formatar o disco!";
        ...
        private void BtnTabGravar_Click(object sender, EventArgs e)
        {
            PnlGravar.Visible = true;
            PnlFormat.Visible = false;

            BtnTabGravar.BackColor = Color.Silver;
            BtnTabFormat.BackColor = Color.Gray;

            BtnTabGravar.Size = new Size(134, 35);
            BtnTabFormat.Size = new Size(134, 31);
        }

        private void BtnTabFormat_Click(object sender, EventArgs e)
        {
            PnlGravar.Visible = false;
            PnlFormat.Visible = true;

            BtnTabGravar.BackColor = Color.Gray;
            BtnTabFormat.BackColor = Color.Silver;

            BtnTabGravar.Size = new Size(134, 31);
            BtnTabFormat.Size = new Size(134, 35);
        }
        ...
        private void updateMidias_Click(object sender, EventArgs e)
        {
            listMidias();
        }
        ...
        private void Gravar_KeyDown_1(object sender, KeyEventArgs e)
        {
            if(e.KeyCode == Keys.Enter)
            {
                buttonBurn_Click(sender, e);
            }
        }
    }
}
